    ...
    extends Exception
{
     ...
     * @param message
     */
    public UnauthorizedException_Exception(String message, Object faultInfo) {
        super(message);
     ...
     * @param message
     */
    public UnauthorizedException_Exception(String message, Object faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
